...
@implementation KitchenBaseModel
...
@end
@implementation ResponseBodyEntity
...
- (id) init
{
    if (self = [super init])
    {
        self.cuisinessName = @"All Cuisines";
...
@implementation UserBackgroundImageModel
@end

@implementation DishStepModel
@end
